...
public class EvtMyPetPickupitem extends SkriptEvent {

    static {
        if (Bukkit.getPluginManager().isPluginEnabled("MyPet")) {
            Bukkit.getLogger().log(Level.INFO, "LoadedEvent: PetPickup");
            Skript.registerEvent("MyPet Pickup Item", EvtMyPetPickupitem.class, MyPetPickupItemEvent.class, "mypet pickup[ item]")
